...
//       const findId = products.filter((e) => e.id === id);
//       console.log(findId[0]);
//       console.log(findId[0]?.images[0]);
//       if (findId) {
//         setNewProductName(findId[0]?.productName);
//         setNewCode(findId[0]?.code);
//         setNewDescription(findId[0]?.description);
//         setNewBrand(findId[0]?.brand);
//         setNewCategory(findId[0]?.category);
//         setNewPrice(findId[0]?.price);
//         setNewDisCount(findId[0]?.disCount);
//         setNewQuantity(findId[0]?.count);
//         setImages(findId?.images || []);
//         setColors(findId?.colors || []);
//       }
//     }
//   }, [id, products]);
