...
import muibox from '../../app/others/images/div.MuiBox-root.png'
import cost from '../../app/others/images/iconly-glass-discount.svg.png'
import profit from '../../app/others/images/div.MuiBox-root (1).png'
 	...
 	<div className='p-5 space-y-8'>
			...
			<Box className='flex flex-col md:flex-row justify-between gap-5'>
         	 ...
         	 <Box className='flex flex-col sm:flex-row justify-between gap-4'>
           		 <Box className='flex-1 h-[100px] cursor-pointer rounded-md bg-[#FEF3F2] p-5 flex items-center gap-4 text-black shadow'>
           		 ...
           		 <Box className='flex-1 h-[100px] cursor-pointer rounded-md bg-[#FFFAEB] p-5 flex items-center gap-4 text-black shadow'>
           		 ...
           		 <Box className='flex-1 h-[100px] cursor-pointer rounded-md bg-[#F0FDF9] p-5 flex items-center gap-4 text-black shadow'>
		...
		<section className='flex flex-col md:flex-row justify-between gap-5'>
				...
				<Box className='md:w-[45%] p-5 border border-gray-200 rounded-md shadow overflow-auto max-h-[400px]'>
					<Typography className='text-xl font-bold mb-4'>Best products by most viewed</Typography>
						...
						<Table className='w-full table-auto text-left'>
							<TableHead className='border-b border-gray-300'>
								<TableRow>
									...
									<TableCell className="py-2">Views</TableCell>
								</TableRow>
						  </TableHead>
						  <TableBody>
